var gameData = [
  {
    ...
    button2: '<button type="click" id="b2" class="game">Excitedly answer yes! You love a good adventure.</button>',
  ...
  },
  {
    ...
    button2: '<button type="click" id="b3" class="game" hidden>Stay with the elves and live a peaceful life.</button>',
  ...
  },
  {
    ...
    button2: '<button type="click" id="b6" class="game" hidden>Follow your gut instinct and go with Frodo and Sam to destroy the ring.</button><br /><br />',
    button3: '<button type="click" id="b6b" class="game" hidden>Fight with Aragorn</button>',
  ...
  },
  {
    ...
    button2: '<button type="click" id="b7" class="game" hidden>Go it alone. The three of you are sure to find the way.</button>',
  ...
  },
  {
    ...
    button2: '<button type="click" id="b10" class="game" hidden>Continue to follow your sketchy leader.</button>',
  ...
  },
  {
    ...
    button2: '<button type="click" id="b12" class="game" hidden>Fight with Sam to save Frodo.</button>',
  ...
  },
  {
    ...
    button2: '<button type="click" id="b14" class="game" hidden>Follow the Orcs to save Frodo.</button>',
  ...
  },
  {
    ...
    button2: '<button type="click" id="b16" class="game" hidden>Come to your sense and throw the Ring into the volcano.</button><br /><br />',
  ...
  },
  {
    ...
    button2: '<button type="click" id="b7b" class="game" hidden>Go home. The Fellowship is better off without you anyways.</button>',
  ...
  },
  {
    ...
    button2: '<button type="click" id="b10b" class="game" hidden>Get ready for another battle by preparing an army.</button>',
  ...
  },
  {
    ...
    button2: '<button type="click" id="b11b" class="game" hidden>Sit this one out and stay with King Theoden.</button>',
  ...
  },
  {
    ...
    button2: '<button type="click" id="b14b" class="game" hidden>Of course you\'re going to join your friends! Till the end!</button>',
    button3: '<button type="click" id="deathbtn7b" class="game" hidden>SELFISH! Because you weren\'t there everyone died and Frodo and Sam did not make it to Mount Doom. Now everyone is dead. Go back one step!</button>',
  }
];
